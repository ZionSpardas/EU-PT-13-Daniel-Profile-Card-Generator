...
function render(variables = {}) {
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <h1>${variables.name ? variables.name : "Kitty"} ${
    variables.lastname ? variables.lastname : "Lucy"
  }</h1>
          <h2>${variables.role ? variables.role : "Looking For A Job"}</h2>
          <h3>${variables.city ? variables.city : "Planet"} , ${
    variables.country ? variables.country : "Earth"
  }</h3>
          <ul class="${
